          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-100">
              {rally.stages.length === 0 && (
                <tr><td colSpan={4} className="px-4 py-8 text-center text-gray-500">No stages added yet.</td></tr>
              )}
                    ...
                    <>
                      ...
                      <td className="px-4 py-2 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button onClick={() => saveEdit(s.id)} className="text-green-600 hover:text-green-800 p-1" title="Save">
                            <Save size={18} />
                          </button>
